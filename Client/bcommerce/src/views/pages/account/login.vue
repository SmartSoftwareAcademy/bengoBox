          ...
          <div class="col-lg-12">
            <div class="text-center">
              <router-link to="/" class="d-block auth-logo">
                <img src="@/assets/logo.png" alt height="100px" class="logo logo-dark pb-0 mb-0" />
                <img src="@/assets/logo.png" alt height="100px" class="logo logo-light pb-0 mb-0" />
              </router-link>
            </div>
          </div>
        </div>
        <div class="row align-items-center justify-content-center pt-0 mt-0">
                ...
                <div class="p-2 mt-4">
                  ...
                  <b-form @submit.prevent="tryToLogIn">
                    ...
                    <b-form-group id="input-group-2" class="mb-3">
                      <div class="float-end">
                        <router-link to="/account/forgot-password" class="text-muted">Forgot password?</router-link>
                      </div>
