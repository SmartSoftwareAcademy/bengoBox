<template>
  <div>
    <v-container>
      <v-alert :value="showAlert" :type="alert_type" @click:close="showAlert = false" dismissible>
        {{ message }}
      </v-alert>
      <div class="row">
        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            ...
            <v-text-field type="number" outlined style="width:100px" :value="1" :step="1" min="1" dense></v-text-field>
            <v-btn class="primary white--text" outlined tile dense @click="addToCart(items[0])"><v-icon>mdi-cart</v-icon>
              ADD TO CART</v-btn>
            <v-btn class="ml-4 pl-4" outlined tile><v-icon class="text-secondary">mdi-heart</v-icon>ADD TO
              WISHLIST</v-btn>
          </div>
        </div>
      </div>
