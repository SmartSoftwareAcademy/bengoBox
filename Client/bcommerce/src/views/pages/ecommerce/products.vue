                ...
                <v-img class="white--text align-end" :aspect-ratio="16 / 9" height="200px" :src="pro.src">
                  ...
                  <v-expand-transition>
                    <div v-if="hover"
                      ...
                      <router-link v-if="hover" :to="{ name: 'Product Detail' }" class="badge badge-pill badge-success"
                        outlined><v-btn href="#" class="bd-primary" icon>
                          <v-icon class="text-primary">mdi-eye</v-icon> </v-btn>
                      </router-link>
                      <v-btn href="#" class="" @click="addToCart(pro)" icon>
                        <v-icon class="text-success">mdi-cart</v-icon>
                      </v-btn>
                    </div>
