                    ...
                    <div class="col-lg-3 col-sm-6">
                      <div>
                        <label class="card-radio-label">
                          ...
                          <span class="card-radio text-center text-truncate">
                            <img :src="require('@/assets/img/shop/mpesa.png')" width="100" height="70" />
                          </span>
                        </label>
                      </div>
                    </div>
              ...
              <table class="table table-centered mb-0 table-nowrap">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 text-truncate">
                        <router-link to="/ecommerce/product-detail/1" class="text-dark">Nike N012 Running
                          Shoes</router-link>
                      </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="font-size-14 text-truncate">
                        <router-link to="/ecommerce/product-detail/1" class="text-dark">Adidas Running Shoes</router-link>
                      </h5>
