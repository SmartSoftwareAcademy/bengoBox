      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <apexchart class="apex-charts" height="380" type="line" dir="ltr" :series="linewithDataChart.series"
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Column Charts -->
            <apexchart class="apex-charts" height="350" type="bar" dir="ltr" :series="columnChart.series"
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <apexchart class="apex-charts" height="350" type="bar" dir="ltr" :series="columnDatalabelChart.series"
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Bar Chart -->
            <apexchart class="apex-charts" height="350" type="bar" dir="ltr" :series="barChart.series"
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <apexchart class="apex-charts" height="350" type="line" dir="ltr" :series="mixedChart.series"
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Radial Chart -->
            <apexchart class="apex-charts" height="380" type="radialBar" dir="ltr" :series="radialChart.series"
              :options="radialChart.chartOptions"></apexchart>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Pie Chart -->
            <apexchart class="apex-charts" height="320" type="pie" dir="ltr" :series="pieChart.series"
              :options="pieChart.chartOptions"></apexchart>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Donut Chart -->
            <apexchart class="apex-charts" height="320" type="donut" dir="ltr" :series="donutChart.series"
