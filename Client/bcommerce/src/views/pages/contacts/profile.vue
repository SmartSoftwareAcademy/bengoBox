                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="text-muted">
                            ...
                            <p>Hi I'm Marcus,has been the industry's standard dummy text To an English person, it will seem
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <b-dropdown right toggle-class="text-muted font-size-18 px-2 p-0"
                                                            variant="white" menu-class="dropdown-menu-end">
                                                            <template v-slot:button-content>
                                                                <i class="uil uil-ellipsis-v"></i>
                                                            </template>
