...
import { layoutComputed, bengoboxauthMethods } from "@/state/helpers";
...
<template>
  <header id="page-topbar">
    <div class="navbar-header">
      ...
      <div class="d-flex">
        ...
        <b-dropdown class="d-inline-block" toggle-class="header-item" right variant="white">
          <template v-slot:button-content>
            <img class="rounded-circle header-profile-user" src="@/assets/parking-3.png" alt="Header Avatar" />
    ...
    <div class="container-fluid bg-success">
      <div class="topnav text-white" style="background:orange;">
